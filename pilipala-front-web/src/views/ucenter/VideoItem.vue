  ...
  <div class="video-item" ref="videoItemRef">
    ...
    <div class="video-info">
      <div class="video-name">
        ...
        >
        <span v-if="data.status == 3" class="status success">{{
          data.statusName
        }}</span>
        <span
    ...
    <div class="op-panel">
      ...
      <el-popover
        ...
        :show-arrow="false"
        ><template #reference
          ><div id="reference"><span class="iconfont icon-more"></span></div
        ></template>
...
onMounted(() => {
  console.log("video data onMounted:", props.data);
...
const deleteVideo = async () => {
  proxy.Confirm({
    message: `确认删除视频“${props.data.videoName}”吗？`,
    okfun: async () => {
      let result = await proxy.Request({
