<template>
  <div>
    <div class="summary-panel">
      <div class="summary" :style="{ height: expandType ? 'auto' : '84px' }">
        <div id="summary-inner" v-html="videoInfo.introduction"></div>
      </div>
      <div class="expand-btn" v-show="showExpandBtn" @click="expand">
        {{ expandType ? "收起" : "展开更多" }}
      </div>
      <div class="tag-list">
        <router-link
