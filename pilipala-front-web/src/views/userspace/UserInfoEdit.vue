  ...
  <div>
    ...
    >
      <el-form
        ...
        @submit.prevent
      >
        <el-form-item label="UID" prop="userId">{{ formData.id }}</el-form-item>
        ...
        <el-form-item label="公告" prop="spaceAnnouncement">
          <el-input
            clearable
            placeholder="公告"
            type="textarea"
            ...
            resize="none"
            show-word-limit
            v-model="formData.spaceAnnouncement"
          />
        </el-form-item>
      </el-form>
    </Dialog>
...
import { ref, getCurrentInstance, provide, nextTick } from "vue";
